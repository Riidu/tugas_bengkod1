...
<head>
  <style>
    ...
    .main-sidebar {
      background-color:rgb(245, 189, 255) !important; /* Hijau Muda */
    ...
    /* Header styling */
    .main-header {
      background-color:rgb(230, 168, 228) !important; /* Hijau muda */
      border-bottom: 1px solidrgb(255, 195, 221); /* Warna lebih gelap untuk pembatas */
    ...
    .sidebar .nav-pills .nav-link.active {
      background-color:rgb(250, 170, 246) !important;
      color: #fff !important;
    ...
    .sidebar .nav-pills .nav-link:hover {
      background-color: rgba(186, 108, 179, 0.2) !important;
      color: #000 !important;
    }
